...
import 'package:playtech_transmitter_app/SlideAnimation/version/grassLens.dart';
import 'package:playtech_transmitter_app/SlideAnimation/version/grass_registry.dart';
...
class GameOdometerChildLed1920x1080CurvedGrassLiquidSlideAnimated extends StatefulWidget {
  ...
  final bool isSmall;
   ...
   const GameOdometerChildLed1920x1080CurvedGrassLiquidSlideAnimated({
    super.key,
  ...
  @override
  _GameOdometerChildLed1920x1080CurvedGrassLiquidSlideAnimatedState createState() => _GameOdometerChildLed1920x1080CurvedGrassLiquidSlideAnimatedState();
}

class _GameOdometerChildLed1920x1080CurvedGrassLiquidSlideAnimatedState extends State<GameOdometerChildLed1920x1080CurvedGrassLiquidSlideAnimated> with TickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(covariant GameOdometerChildLed1920x1080CurvedGrassLiquidSlideAnimated oldWidget) {
